...
app.get('/api/datatable', function(request, response) {
	// this is the return from the mongo
	...
	// fieldArr.push(mongoarray[i].field2.toString()); 
	// fieldArr.push(mongoarray[i].field3.toString()); 
	// fieldArr.push(mongoarray[i].field4.toString()); 
	// fieldArr.push(mongoarray[i].field5.toString()); 
	// fieldArr.push(mongoarray[i].field6.toString()); 
...
MongoClient.connect('mongodb://localhost:27017', (err, client) => {
	...
	app.get('/students', (req, res) => {
		...
		.post('/students', (req, res) => {
			...
			db.collection('students').insert(req.body, (err, data) => {
				if (err) return console.log(err);
				res.json(('Data saved: ' + JSON.stringify(data)));
